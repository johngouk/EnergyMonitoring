"""
    ...
    The Tuya device gets a bit fed up after a bit and stops responding. THe plan is to use a Tasmota
    MQTT-controlled switch to turn it off/on if we get an error here, which should wake it up.
...
tuya_dev_id='bf50b227c08135cd81ggar'
tuya_address='192.168.68.104'  # Or set to 'Auto' to auto-discover IP address
tuya_local_key='f)=DnYdajV4P=E)h'  # 'f)=DnYdajV4P=E)h'

logfile = 'tuyaReader.log'
